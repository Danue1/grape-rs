...
impl<'parse> Parse<'parse> {
    pub fn field_definitions(&mut self) -> Result<Option<(Span, Vec<FieldDefinition>)>, Message> {
    ...
    pub fn field_definition(&mut self) -> Result<Option<FieldDefinition>, Message> {
    ...
    ) -> Result<Option<FieldDefinition>, Message> {
